...
var DatePickerDialog = function (_Component) {
  ...
  _createClass(DatePickerDialog, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['DateTimeFormat', 'cancelClassName', 'cancelLabel', 'cancelStyle', 'container', 'disableYearSelection', 'initialDate', 'firstDayOfWeek', 'locale', 'maxDate', 'minDate', 'mode', 'okClassName', 'okLabel', 'okStyle', 'onAccept', 'shouldDisableDate', 'style', 'wordings']);
