...
var DatePicker = function (_Component) {
  ...
  _createClass(DatePicker, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['DateTimeFormat', 'autoOk', 'cancelClassName', 'cancelLabel', 'cancelStyle', 'className', 'container', 'defaultDate', 'disableYearSelection', 'firstDayOfWeek', 'locale', 'maxDate', 'minDate', 'mode', 'okClassName', 'okLabel', 'okStyle', 'onDismiss', 'onFocus', 'onShow', 'onTouchTap', 'shouldDisableDate', 'style', 'textFieldStyle', 'wordings']);
...
DatePicker.propTypes = {
   ...
   */
  okStyle: _react.PropTypes.object,
  /**
